...
type ReleaseOperationsAPIController struct {
	service ReleaseOperationsAPIServicer
...
func WithReleaseOperationsAPIErrorHandler(h ErrorHandler) ReleaseOperationsAPIOption {
	return func(c *ReleaseOperationsAPIController) {
		c.errorHandler = h
	}
}
...
func NewReleaseOperationsAPIController(s ReleaseOperationsAPIServicer, opts ...ReleaseOperationsAPIOption) Router {
	controller := &ReleaseOperationsAPIController{
		service:      s,
...
func (c *ReleaseOperationsAPIController) Routes() Routes {
	return Routes{
		...
		"GetReleasePlan": Route{
			strings.ToUpper("Get"),
			"/v3/releases/{release_slug}/plans/{plan_name}",
			c.GetReleasePlan,
		},
		"GetReleasePlans": Route{
			strings.ToUpper("Get"),
...
func (c *ReleaseOperationsAPIController) AddRelease(w http.ResponseWriter, r *http.Request) {
	addReleaseRequestParam := AddReleaseRequest{}
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	if err := d.Decode(&addReleaseRequestParam); err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
	}
	if err := AssertAddReleaseRequestRequired(addReleaseRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertAddReleaseRequestConstraints(addReleaseRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.AddRelease(r.Context(), addReleaseRequestParam)
...
func (c *ReleaseOperationsAPIController) DeleteRelease(w http.ResponseWriter, r *http.Request) {
	...
	releaseSlugParam := chi.URLParam(r, "release_slug")
	if releaseSlugParam == "" {
		c.errorHandler(w, r, &RequiredError{"release_slug"}, nil)
		return
	}
	...
	result, err := c.service.DeleteRelease(r.Context(), releaseSlugParam, reasonParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ReleaseOperationsAPIController) GetFile(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.GetFile(r.Context(), filenameParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ReleaseOperationsAPIController) GetRelease(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.GetRelease(r.Context(), releaseSlugParam, withHtmlParam, includeFieldsParam, excludeFieldsParam, ifModifiedSinceParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ReleaseOperationsAPIController) GetReleasePlan(w http.ResponseWriter, r *http.Request) {
	...
	planNameParam := chi.URLParam(r, "plan_name")
	if planNameParam == "" {
		c.errorHandler(w, r, &RequiredError{"plan_name"}, nil)
		return
	}
	result, err := c.service.GetReleasePlan(r.Context(), releaseSlugParam, planNameParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ReleaseOperationsAPIController) GetReleasePlans(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.GetReleasePlans(r.Context(), releaseSlugParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *ReleaseOperationsAPIController) GetReleases(w http.ResponseWriter, r *http.Request) {
	...
	var moduleParam string
	if query.Has("module") {
		param := query.Get("module")
	...
	result, err := c.service.GetReleases(r.Context(), limitParam, offsetParam, sortByParam, moduleParam, ownerParam, withPdkParam, operatingsystemParam, operatingsystemreleaseParam, peRequirementParam, puppetRequirementParam, moduleGroupsParam, showDeletedParam, hideDeprecatedParam, withHtmlParam, includeFieldsParam, excludeFieldsParam, ifModifiedSinceParam, supportedParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
