...
// UserOperationsAPIService is a service that implements the logic for the UserOperationsAPIServicer
// This service should implement the business logic for every endpoint for the UserOperationsAPI API.
...
func NewUserOperationsAPIService() UserOperationsAPIServicer {
	return &UserOperationsAPIService{}
}
...
func (s *UserOperationsAPIService) GetUsers(ctx context.Context, limit int32, offset int32, sortBy string, withHtml bool, includeFields []string, excludeFields []string, ifModifiedSince string) (ImplResponse, error) {
	...
	// return Response(200, GetUsers200Response{}), nil
