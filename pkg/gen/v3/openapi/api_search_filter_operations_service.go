...
// SearchFilterOperationsAPIService is a service that implements the logic for the SearchFilterOperationsAPIServicer
// This service should implement the business logic for every endpoint for the SearchFilterOperationsAPI API.
...
func NewSearchFilterOperationsAPIService() SearchFilterOperationsAPIServicer {
	return &SearchFilterOperationsAPIService{}
}
...
func (s *SearchFilterOperationsAPIService) AddSearchFilter(ctx context.Context, searchFilterSlug string, withHtml bool, includeFields []string, excludeFields []string, ifModifiedSince string) (ImplResponse, error) {
	...
	return Response(http.StatusNotImplemented, nil), errors.New("AddSearchFilter method not implemented")
}
...
func (s *SearchFilterOperationsAPIService) DeleteUserSearchFilter(ctx context.Context, id int32) (ImplResponse, error) {
	...
	return Response(http.StatusNotImplemented, nil), errors.New("DeleteUserSearchFilter method not implemented")
}
...
func (s *SearchFilterOperationsAPIService) GetUserSearchFilters(ctx context.Context) (ImplResponse, error) {
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetUserSearchFilters method not implemented")
}
